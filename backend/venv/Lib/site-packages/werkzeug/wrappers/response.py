...
def _iter_encoded(iterable: t.Iterable[str | bytes]) -> t.Iterator[bytes]:
    """Iterate over an iterable and yield encoded bytes.
    
    Args:
        iterable (Iterable[str | bytes]): An iterable containing strings or bytes.
    
    Returns:
        Iterator[bytes]: An iterator yielding encoded bytes.
    """
...
class Response(_SansIOResponse):
    ...
    def __init__(
        ...
        Args:
            response (Union[Iterable[bytes], bytes, Iterable[str], str, None]): The response body. Defaults to None.
            status (Union[int, str, HTTPStatus, None]): The status code for the response. Defaults to None.
            headers (Union[Mapping[str, Union[str, Iterable[str]]], Iterable[Tuple[str, str]], None]): The headers for the response. Defaults to None.
            mimetype (Optional[str]): The MIME type of the response. Defaults to None.
            content_type (Optional[str]): The content type of the response. Defaults to None.
            direct_passthrough (bool): Whether to pass the response body directly through as the WSGI iterable. Defaults to False.
    ...
    def __repr__(self) -> str:
        ...
        Returns:
            str: A string representation containing information about the object's type, body content, and status.
        """
        if self.is_sequence:
    ...
    Args:
        as_text (Literal[False], optional): Flag to determine if the data should be returned as text. Defaults to False.
    
    Returns:
        bytes: The retrieved data in bytes format.
    """
    def get_data(self, as_text: t.Literal[False] = False) -> bytes: ...

    @t.overload
    """Retrieves data and returns it as a string.
    
    Args:
        as_text (Literal[True]): A boolean flag indicating that the data should be returned as text.
    ...
    def is_sequence(self) -> bool:
        ...
        .. versionadded:: 0.6
        """
        Enter the context manager for the Response object.
        
        Args:
            self: The instance of the Response class.
        
        Returns:
            Response: The Response object itself, allowing it to be used in a with statement.
        """
        """
    ...
    def json(self) -> t.Any | None:
        ...
        Args:
            force (bool, optional): If True, forces re-parsing of the request data. Defaults to Ellipsis.
            silent (Literal[False], optional): If False, may raise a 400 Bad Request error if the request is invalid. Defaults to Ellipsis.
        
        Returns:
            Any: The parsed JSON data from the request.
        """
        ...
        Args:
            force (bool, optional): If True, ignores the mimetype and always tries to parse JSON.
            silent (bool, optional): If True, returns None instead of raising an error if parsing fails.
        
        Returns:
            t.Any | None: The parsed JSON data if successful, or None if parsing fails and silent is True.
        """
...
class ResponseStream:
    ...
    def __init__(self, response: Response):
        """Initialize a ResponseContextManager.
        
        Args:
            response (Response): The response object to be managed.
    ...
    def write(self, value: bytes) -> int:
        """Writes bytes to the file-like object.
        
        Args:
            value (bytes): The bytes to be written to the file.
        
        Returns:
            int: The number of bytes written.
        
        Raises:
            ValueError: If an I/O operation is attempted on a closed file.
        """
        if self.closed:
    ...
    def writelines(self, seq: t.Iterable[bytes]) -> None:
        ...
        Args:
            seq (Iterable[bytes]): An iterable containing byte sequences to be written.
...
"""
    ...
    def flush(self) -> None:
        """Flushes the internal buffer of the file object.
        
        Args:
            self: The instance of the file object.
"""Check if the file object is connected to a terminal device.

Args:
    self: The file object instance.

Returns:
    bool: Always returns False for this implementation, indicating that the file object is not connected to a terminal device.

Raises:
    ValueError: If the file object is closed when this method is called.
"""
    ...
    Returns:
        str: The encoding type, which is always 'utf-8'.
    """
    ...
    def tell(self) -> int:
        """
        Returns the total length of all sequences in the response.
        
        Args:
            self: The instance of the class containing this method.
        
        Returns:
            int: The sum of the lengths of all sequences in the response.
        """
