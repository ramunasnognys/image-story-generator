...
class Request(_SansIORequest):
    ...
    def __init__(
        ...
        """Initialize a Request object based on a WSGI environment.
        
        Args:
            environ (WSGIEnvironment): The WSGI environment dictionary.
            populate_request (bool): Whether to populate the 'werkzeug.request' key in the environment. Defaults to True.
            shallow (bool): If True, creates a shallow copy of the Request object. Defaults to False.
        
        Returns:
            None: This method initializes the Request object and doesn't return anything.
        """
        super().__init__(
    ...
    def application(cls, f: t.Callable[[Request], WSGIApplication]) -> WSGIApplication:
        ...
        def application(*args: t.Any) -> cabc.Iterable[bytes]:
            """Wrapper function for handling WSGI applications with custom request handling.
            
            Args:
                *args (Any): Variable length argument list, where the last two arguments are expected to be WSGI environment and start_response function.
            
            Returns:
                Iterable[bytes]: The response body as an iterable of bytes.
            """
            request = cls(args[-2])
            with request:
                try:
    ...
    def __enter__(self) -> Request:
        """Enter the context manager for the Request object.
        ...
        Args:
            ...
            Args:
                exc_type (Type[BaseException] | None): The type of the exception that caused the context to be exited, if any.
                exc_value (BaseException | None): The instance of the exception that caused the context to be exited, if any.
                tb (TracebackType | None): A traceback object encapsulating the call stack at the point where the exception occurred.
            
            Returns:
                None: This method doesn't return anything.
            """
            self: The instance of the Request class.
        
        Returns:
            Request: The Request object itself, allowing it to be used in a with statement.
        """
        return self
    ...
    def data(self) -> bytes:
        ...
        """
        """Retrieves data from the request, with options for caching and parsing.
        
        Args:
            cache (bool, optional): Whether to cache the retrieved data. Defaults to True.
            as_text (Literal[False]): Flag to indicate if the data should be returned as text. Must be False.
            parse_form_data (bool, optional): Whether to parse form data. Defaults to False.
        
        Returns:
            bytes: The retrieved data as bytes.
        """
    ...
    Args:
        cache (bool): Whether to cache the parsed data. Defaults to True.
        as_text (Literal[True]): Forces the return value to be a string.
        parse_form_data (bool): Whether to parse form data. Defaults to False.
    ...
    Args:
        force (bool, optional): If True, ignores the mimetype and always attempts to parse JSON.
        silent (Literal[False], optional): If False, raises an error if parsing fails.
        cache (bool, optional): If True, caches the parsed JSON data.
    ...
    Args:
        force (bool, optional): If True, ignores the mimetype and always attempts to parse JSON.
        silent (bool, optional): If True, silently returns None instead of raising an error when parsing fails.
        cache (bool, optional): If True, caches the parsed JSON data for subsequent calls.
    
    Returns:
        t.Any | None: The parsed JSON data as a Python object, or None if parsing fails and silent is True.
    """
