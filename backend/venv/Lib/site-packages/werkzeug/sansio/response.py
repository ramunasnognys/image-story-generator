...
class Response:
    ...
    def www_authenticate(
        ...
        """Sets or removes the WWW-Authenticate header in the response.
        
        Args:
            value (WWWAuthenticate | list[WWWAuthenticate] | None): The WWW-Authenticate value(s) to set. Can be a single WWWAuthenticate object, a list of WWWAuthenticate objects, or None to remove the header.
        ...
        if not value:  # None or empty list
            ...
            """
            Removes the 'WWW-Authenticate' header from the response headers if present.
            ...
            """
            def on_update(value: WWWAuthenticate) -> None:
                """Updates the WWWAuthenticate value for the instance.
                
                Args:
                    value (WWWAuthenticate): The new WWWAuthenticate value to be set.
    ...
    def content_security_policy(self) -> ContentSecurityPolicy:
        ...
        def on_update(csp: ContentSecurityPolicy) -> None:
            """
            Updates the Content Security Policy header in the response.
            
            Args:
                csp (ContentSecurityPolicy): The Content Security Policy object to be applied.
            
            Returns:
                None: This method doesn't return anything, it modifies the headers in place.
            """
            if not csp:
    ...
    def content_security_policy(
        ...
        """Sets or removes the Content Security Policy header.
        
        Args:
            value (ContentSecurityPolicy | str | None): The Content Security Policy value. 
                If ContentSecurityPolicy object, it will be converted to a string.
                If string, it will be set directly.
                If None, the header will be removed.
    ...
    def content_security_policy_report_only(self) -> ContentSecurityPolicy:
        ...
        def on_update(csp: ContentSecurityPolicy) -> None:
            """Updates the Content Security Policy (CSP) header in report-only mode.
        ...
        """Sets or removes the Content-Security-Policy-Report-Only header.
        
        Args:
            value (Union[ContentSecurityPolicy, str, None]): The value to set for the header. If None, the header is removed. If a string, it's set directly. If a ContentSecurityPolicy object, its to_header() method is called.
    ...
    def access_control_allow_credentials(self, value: bool | None) -> None:
        """
        Sets the Access-Control-Allow-Credentials header for CORS (Cross-Origin Resource Sharing).
        
        Args:
            value (bool | None): If True, sets the header to "true". If False or None, removes the header.
